...

{
  ...
  config = mkIf config.boot.initrd.enable {
    assertions = [
      {
        assertion = (any (fs: fs.mountPoint == "/") fileSystems) || config.boot.initrd.allowNoRootMount;
        message = "The ‘fileSystems’ option does not specify your root file system and `allowNoRootMount` is disabled.";
      }
      {
